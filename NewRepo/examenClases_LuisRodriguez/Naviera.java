...
import NewRepo.marditasea.Barco.Barco;
import NewRepo.marditasea.vehiculos.Camion;
import NewRepo.marditasea.vehiculos.Coche;
import NewRepo.marditasea.vehiculos.Motocicleta;
...
public class Naviera {
    ...
    public static void main(String[] args) {
        ...
        elCano.embarcarVehiculo(v5);
        elCano.embarcarVehiculo(v6);  //NO CABEN MAS Vehiculos


       
        System.out.println("----------------------------------------");
        elCano.informacionBarco();
        System.out.println("----------------------------------------");
        ...
        titanic.informacionPasajeros();
        System.out.println("----------------------------------------");
        titanic.informacionVehiculos();
        System.out.println("----------------------------------------");
	...
	Vehiculos (5)
	Motocicleta: matricula=OUGY-9740- propietario=Pedro - Hernández - Brasileña - Camarote: true (Codigo=1 ) - Cilindrada: 339 - ConCarnet: true
	Coche: matricula=TROO-4706- propietario=Juan - Fernández - Colombiana - Camarote: true (Codigo=2 ) - Num Puestas: 3 -Es particular: true
	Camion: matricula=GLKZ-2936- propietario=Miguel - Sánchez - Venezolana - Camarote: false (Codigo=3 ) - Capacidad Carga: 8434
	Motocicleta: matricula=WAEJ-6348- propietario=Juan - García - Venezolana - Camarote: true (Codigo=4 ) - Cilindrada: 56 - ConCarnet: true
	Camion: matricula=ZDAC-5327- propietario=Miguel - Sánchez - Brasileña - Camarote: true (Codigo=5 ) - Capacidad Carga: 10921
	...
	Vehiculos (7)
	Motocicleta: matricula=EGOK-3521- propietario=Miguel - Sánchez - Brasileña - Camarote: true (Codigo=11 ) - Cilindrada: 417 - ConCarnet: true
	Camion: matricula=UHAQ-8122- propietario=María - García - Mexicana - Camarote: true (Codigo=12 ) - Capacidad Carga: 18397
	Motocicleta: matricula=IBHA-1502- propietario=Carlos - Hernández - Argentina - Camarote: true (Codigo=13 ) - Cilindrada: 193 - ConCarnet: false
	Motocicleta: matricula=IMCO-1402- propietario=Juan - Pérez - Uruguaya - Camarote: true (Codigo=14 ) - Cilindrada: 375 - ConCarnet: true
	Coche: matricula=JBJA-2056- propietario=María - Jiménez - Mexicana - Camarote: true (Codigo=15 ) - Num Puestas: 5 -Es particular: true
	Camion: matricula=KKVH-6698- propietario=Juan - García - Brasileña - Camarote: true (Codigo=16 ) - Capacidad Carga: 8152
	Camion: matricula=QQRA-8107- propietario=María - González - Venezolana - Camarote: false (Codigo=17 ) - Capacidad Carga: 13320

	 * DESEMBARCA el Camion: matricula=QQRA-8107- propietario=María - González - Venezolana - Camarote: false (Codigo=17 ) - Capacidad Carga: 13320
	 * DESEMBARCA el pasajero: María - González - Venezolana - Camarote: false (Codigo=17 )
	 * DESEMBARCA el Camion: matricula=KKVH-6698- propietario=Juan - García - Brasileña - Camarote: true (Codigo=16 ) - Capacidad Carga: 8152
	...
	----------------------------------------
	 * DESEMBARCA el Coche: matricula=JBJA-2056- propietario=María - Jiménez - Mexicana - Camarote: true (Codigo=15 ) - Num Puestas: 5 -Es particular: true
	 * DESEMBARCA el pasajero: María - Jiménez - Mexicana - Camarote: true (Codigo=15 )
	 * DESEMBARCA el Motocicleta: matricula=IMCO-1402- propietario=Juan - Pérez - Uruguaya - Camarote: true (Codigo=14 ) - Cilindrada: 375 - ConCarnet: true
	 * DESEMBARCA el pasajero: Juan - Pérez - Uruguaya - Camarote: true (Codigo=14 )
	 * DESEMBARCA el Motocicleta: matricula=IBHA-1502- propietario=Carlos - Hernández - Argentina - Camarote: true (Codigo=13 ) - Cilindrada: 193 - ConCarnet: false
	 * DESEMBARCA el pasajero: Carlos - Hernández - Argentina - Camarote: true (Codigo=13 )
	 * DESEMBARCA el Camion: matricula=UHAQ-8122- propietario=María - García - Mexicana - Camarote: true (Codigo=12 ) - Capacidad Carga: 18397
	 * DESEMBARCA el pasajero: María - García - Mexicana - Camarote: true (Codigo=12 )
	 * DESEMBARCA el Motocicleta: matricula=EGOK-3521- propietario=Miguel - Sánchez - Brasileña - Camarote: true (Codigo=11 ) - Cilindrada: 417 - ConCarnet: true
	 * DESEMBARCA el pasajero: Miguel - Sánchez - Brasileña - Camarote: true (Codigo=11 )
