...
public class UsoTIenda {
    public static void main(String[] args) {
        ...
        tienda.getDescuentosPorCategorias().insertar("Electronica", 5);
        tienda.getDescuentosPorCategorias().insertar("Hogar", 10);
        tienda.getDescuentosPorCategorias().insertar("Hogar", 5);
        
        System.out.println("---- DESCUENTOS FIJADOS ----");
        System.out.println(tienda.getDescuentosPorCategorias().mostrarDescuentos());
        System.out.println();
